...
- (void)setupUI{
    ...
    [self.collectionView registerClass:[DKGameImageCell class] forCellWithReuseIdentifier:collectionViewCell];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    DKGameImageCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:collectionViewCell forIndexPath:indexPath];
