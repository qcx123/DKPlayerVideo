...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[DKGameMsgCell class] forCellReuseIdentifier:magCell];
    [self.tableView registerClass:[DKGameGiftCell class] forCellReuseIdentifier:giftCell];
    [self.tableView registerClass:[DKGameVideoListCell class] forCellReuseIdentifier:videoListCell];
}
